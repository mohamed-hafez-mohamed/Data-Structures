...
typedef ElementType_t NodeEntry_t;
...
void LIST_u8ReplaceElement(u8 Copy_u8ElementPosition, NodeEntry_t  * Copy_ptrToElement, List_t * Copy_ptrToList);
...
void LIST_voidInsertOrder(NodeEntry_t * Copy_ptrToElement,List_t * Copy_ptrToList);
