...
void STACK_voidStackTop(StackEntry_t *Copy_ptrToStackEntry,Stack_t *Copy_ptrToStack)
{
...
{
   u8 Local_u8Counter;
   for(Local_u8Counter = Copy_ptrToStack -> StackTop;Local_u8Counter > 0;Local_u8Counter--)
   {
      CallBackFunction(Copy_ptrToStack->StackEntry[Local_u8Counter - 1]);
   }
}
/*************** END OF FUNCTIONS ***************************************************************************/
